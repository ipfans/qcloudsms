...
const (
	ErrCodeOK                 = 0    // 请求成功
	ErrCodeSig                = 1001 // sig校验失败	请核对API的sig格式说明
	ErrCodeSensitiveWord      = 1002 // 短信/语音内容中含有敏感词	应答包会返回该敏感词，请去掉该敏感词后重新发送
	ErrCodeCodeSigNil         = 1003 // 请求包体没有sig字段或sig为空	请遵守API接口说明规范
	ErrCodeRequestParseFailed = 1004 // 请求包解析失败，通常情况下是由于没有遵守API接口说明规范导致的	可参考1004错误详解
	ErrCodePermissionDenied   = 1006 // 请求没有权限，比如没有扩展码权限等	请查看错误提示语说明，如还有问题请提供失败手机号联系sms helper
	ErrCodeOther              = 1007 // 其他错误	请查看错误提示语说明，如还有问题请提供失败手机号联系sms helper
	ErrCodeRetry              = 1008 // 请求下发短信/语音超时	出现概率很低，可重试解决
	ErrCodeIPNotAllow         = 1009 // 请求ip不在白名单中	您配置了校验请求来源ip，但是检测到当前请求ip不在配置列表中，如有需要请联系sms helper
	ErrCodeNoRestfulAPI       = 1011 // 不存在该REST API接口	请核查REST API接口说明
	ErrCodeSMSSignature       = 1012 // 签名格式错误或者签名未审批	签名只能由中英文、数字组成，要求2~8个字;如果符合签名格式规范，请核查签名是否已审批
	ErrCodeSMSTooFrequently   = 1013 // 下发短信/语音命中了频率限制策略	可自行到控制台调整短信频率限制策略；语音如有需要请联系sms helper
	ErrCodeTemplateNotAllow   = 1014 // 模版未审批或请求的内容与审核通过的模版内容不匹配	可参考1014错误详解
	ErrCodeBlackList          = 1015 // 手机号在黑名单库中,通常是用户退订或者命中运营商黑名单导致的	可联系sms helper解决
	ErrCodeMobileNumber       = 1016 // 手机号格式错误	请核查下发短信/语音的用户手机号格式是否正确
	ErrCodeSMSTooLong         = 1017 // 请求的短信内容太长	短信内容长度超过限制，请调整短信长度
	ErrCodeVoiceParseFailed   = 1018 // 语音验证码格式错误	请遵守API接口说明规范
	ErrCodeAppIDNotFound      = 1019 // sdkappid不存在
	ErrCodeAppIDDisabled      = 1020 // sdkappid已禁用	此sdkappid禁止提供服务，如有需要请联系sms helper
	ErrCodeTimestamp          = 1021 // 请求发起时间不正常，通常是由于您的服务器时间与腾讯云服务器时间差异超过10分钟导致的	请核对服务器时间及API接口中的时间字段是否正常
	ErrCodeDailyLimit         = 1022 // 业务短信日下发条数超过设定的上限	可自行到控制台调整短信频率限制策略
	ErrCodeMobileMinuteLimit  = 1023 // 单个手机号30秒内下发短信条数超过设定的上限	可自行到控制台调整短信频率限制策略
	ErrCodeMobileHourlyLimit  = 1024 // 单个手机号1小时内下发短信条数超过设定的上限	可自行到控制台调整短信频率限制策略
	ErrCodeMobileDailyLimit   = 1025 // 单个手机号日下发短信条数超过设定的上限	可自行到控制台调整短信频率限制策略
	ErrCodeMobileContentLimit = 1026 // 单个手机号下发相同内容超过设定的上限	可自行到控制台调整短信频率限制策略
)

// const(
// 	DELIVRD	三网	用户短信接收成功	无
// UNDELIVRD	三网	空号、停机或关机	无
// MX:0003	三网	单个手机号码当天下行条数超过上限	请联系sms helper解除限制
// REJECTD	三网	短消息因某种原因被拒绝	请核实手机终端是否处于正常状态
// MX:0012	三网	目标号码在客户退订黑名单中	用户回复上行退订信息后加黑的，请联系sms helper解除黑名单
// MX:0011	三网	目标号码在禁1年黑名单中	禁1年黑名单中的号码均为恶意投诉号码，或是多次投诉的高危号码
// BWLIST _006	三网	网关黑名单	请联系sms helper沟通解决
// TE:0003	三网	单个手机号码当天下行条数超过上限	请联系sms helper解除限制
// TE:0014	三网	人工审核不通过	请联系sms helper沟通
// TE:0002	三网	向网关提交短信失败	无
// TD:0001	三网	网关黑名单	请联系sms helper沟通解决
// TD:0004	三网	疑似钓鱼，请核实
// TD:19	三网	黑名单号码	请联系sms helper沟通解决
// TD:18	三网	未知运营商号码	无
...
// BWLIST	移动	网关黑名单	请联系sms helper解除黑名单
// HD:19	移动	网关黑名单	请联系sms helper解除黑名单
// MI00020	移动	短信下发手机终端失败ErrorinMS	无
...
// MI:0052	移动	漫游限制	无
// MK:0003	移动	非法用户。本次短消息发送过程中，用户鉴权未通过，可能的原因是MSC认为该手机的鉴权密码非法。在维测台中的错误值为3。在ETSI GSM 0902协议中定义为9。	无
...
// MK:0048	移动	运营商内部错误	无
// MK:0056	移动	运营商内部错误	无
// MK:0057	移动	运营商内部错误	无
// MK:0088	移动	vmsc返回潜在的版本不匹配	无
// TUIDING	移动	运营商黑名单	无
...
// MN:xxxx	移动	M开头的移动错误代码是指Mobile，大多是因为手机端问题导致。原因有：关机，停机，信号弱，不在服务区，无效号码等等。	无
// MK:xxxx	移动	M开头的移动错误代码是指Mobile，大多是因为手机端问题导致。原因有：关机，停机，信号弱，不在服务区，无效号码等等。	无
// MI:xxxx	移动	M开头的移动错误代码是指Mobile，大多是因为手机端问题导致。原因有：关机，停机，信号弱，不在服务区，无效号码等等。	无
// TA:169	移动	空号	无
// TC:0001	移动	黑名单号码	请联系sms helper沟通解决
// TC:0007	移动	短信内容涉及敏感词	请联系sms helper沟通
// 12	联通	计费地址错(空号、关机、停机、通话被限制或者转到联通秘书)	请核实手机终端是否处于正常状态
// 1	联通	空号、号码不存在	请核实手机终端是否处于正常状态
// 10	联通	Src_ID错(空号、关机、停机、通话被限制或者转到联通秘书)	请核实手机终端是否处于正常状态
// 24	联通	计费号码无效（用户不在使用）	请核实手机终端是否处于正常状态
// 5	联通	号码已停机	请核实手机终端是否处于正常状态
// 29	联通	手机用户信息错误	请确认手机号码状态是否为正确状态
...
// 59	联通	运营商内部错误	请提供具体号码给sms helper，下工单向运营商核实
// 15	联通	号码不在服务区	请核实手机终端是否处于正常状态
// 23	联通	运营商内部错误	请提供具体号码给sms helper，下工单向运营商核实
// 27	联通	手机不支持短消息	请核实手机终端是否处于正常状态，如正常可请用户致电联通客服确认号码的短信业务是否开通
// W-BLACK	联通	号码为全局黑名单	请提供具体号码给sms helper解除黑名单
// 17	联通	运营商内部错误	无
...
// 2	联通	运营商内部错误	无
// 104	联通	运营商内部错误	无
// 92	联通		请提供具体号码给sms helper，下工单向运营商核实
// 86	联通	号码不在服务区	无
// 50	联通	停机	无
// 8	联通	信息长度错	无
// 57	联通	运营商内部错误	无
...
// 3	联通	运营商内部错误	无
// 255	联通		请提供具体号码给sms helper，下工单向运营商核实
// 100	联通		请提供具体号码给sms helper，下工单向运营商核实
// 61	联通	号码是空号	请核实手机终端是否处于正常状态
// 117	联通		请提供具体号码给sms helper，下工单向运营商核实
// 45	联通	号码停机	请核实手机终端是否处于正常状态
// 164	联通		请提供具体号码给sms helper，下工单向运营商核实
// 46	联通		请提供具体号码给sms helper，下工单向运营商核实
// 14	联通	运营商内部错误	无
...
// 103	联通		请提供具体号码给sms helper，下工单向运营商核实
...
// UNDELIV_999	电信		请提供具体号码给sms helper，下工单向运营商核实
...
// UNDELIV_713	电信		请提供具体号码给sms helper，下工单向运营商核实
// UNDELIV_615	电信		请提供具体号码给sms helper，下工单向运营商核实
...
// UNDELIV_765	电信		请提供具体号码给sms helper，下工单向运营商核实
// UNDELIV_870	电信	运营商内部错误	无
// UNDELIV_899	电信		请提供具体号码给sms helper，下工单向运营商核实
// EXPIRED_001	电信		请提供具体号码给sms helper，下工单向运营商核实
// UNDELIV_612	电信		请提供具体号码给sms helper，下工单向运营商核实
// UNDELIV_714	电信		请提供具体号码给sms helper，下工单向运营商核实
...
// EXPIRED_010	电信	短消息超过有效期	手机终端超时未响应
...
// MOBILE BLACK	电信/联通	号码为全局黑名单	请联系sms helper解除黑名单
// 其他	电信/联通	运营商未公布原因	请提供具体号码给sms helper，下工单向运营商核实
// )
